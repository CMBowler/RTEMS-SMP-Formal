...
inline taskSelect(schedID, prevRanTask, TimeSliceCounter) {
  atomic {
    byte queueID = 0;
    byte taskId;
    do
...
proctype Scheduler(byte schedID) {
  ...
  ::  else ->
        ...
        */
        ...
        taskSelect(schedID, prevRanTask, TimeSliceCounter);
